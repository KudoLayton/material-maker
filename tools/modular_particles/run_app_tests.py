...
def main():
    ...
    if args.test in ['all', 'legacy:all']:
        ...
        if args.test == 'all': requested = ['test_namespace_model', 'test_namespace_editor', 'test_editor', 'test_module_rename', 'test_module_input_delete', 'test_graph_backend', 'test_mmtest', 'test_export'] + requested
