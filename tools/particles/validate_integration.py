...
def main():
    ...
    print(text)
    for name in ['quaternion', 'transform_read', 'transform_output', 'transform_ui', 'transform_workflow', 'preview', 'preview_ui', 'defaults', 'defaults_ui', 'gpu', 'runtime', 'app', 'constant_ui', 'port_ui', 'random', 'unified', 'sampling', 'profiles', 'workflow', 'examples', 'internal', 'textures', 'parameters', 'parameter_edit_ui', 'parameter_array_ui']:
