...
def main():
    ...
    print(text)
    for name in ['defaults', 'defaults_ui', 'gpu', 'runtime', 'app', 'constant_ui', 'port_ui', 'random', 'unified', 'sampling', 'profiles', 'workflow', 'examples', 'internal', 'textures', 'parameters', 'parameter_edit_ui', 'parameter_array_ui']:
